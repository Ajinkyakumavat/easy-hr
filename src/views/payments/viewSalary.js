...
const ViewSalary = () => {
    ...
    const getAttendence2 = (employee) => {
        let count = 0;

        for (let j = 0; j < employeeAttendance.length; j += 1) {
            if (employeeAttendance[j]?.employee === employee) {
                for (let i = 0; i < (employeeAttendance[j]).length; i += 1) {
                    if (employeeAttendance[j]) {
                        count += 1;
                    }
                }

                return { count, allowance: employeeAttendance[j] };
            }
        }
        return 0;
    }
                ...
                <table style={{ textAlign: 'center', width: '100%', borderCollapse: 'collapse' }} width="100%">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>Payable Amount
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                >
                    <thead>
                        ...
                        <tr>
                            ...
                            <th style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>Rate</th>
                            <th style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>Work<br />(Days)</th>
                            <th style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>Rate</th>
                            <th style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>Extra Earned</th>
                            <th style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>OT<br />Hrs</th>
                            <th style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>OT<br />Rates</th>
                    ...
                    <tbody>
                        {pdfData?.employees?.map((item, index) => {
                            ...
                            /* eslint no-underscore-dangle: 0 */
                            const count = getAttendence(item._id);
                            const count2 = getAttendence2(item._id)
                                ...
                                <tr>
                                    ...
                                    <td style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>
                                        ...
                                        <tr style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <td>
                                                {count2?.allowance?.extraMachineWork}
                                            </td>
                                        </tr>
                                    </td>
                                    ...
                                    <td style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>
                                        <tr style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <td>
                                                {item.salaryDetails.machineRate}
                                            </td>
                                        </tr>
                                    </td>
                                    <td style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>
                                        {/* {count2.allowance?.filter((allowanceRow) => allowanceRow?.category === "Extra Machine Work")?.map((allowanceRow) => {
                                            return (
                                                <tr style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                    <td>{allowanceRow?.value ?? 0}</td>
                                                </tr>
                                            );
                                        })}
                                        {count2.allowance && count2.allowance.length === 0 && (
                                            <tr style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                <td>0</td>
                                            </tr>
                                        )} */}
                                        <tr style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <td>
                                                {Math.round((count2?.allowance?.extraMachineWork) * item.salaryDetails.machineRate)}
                                            </td>
                                        </tr>
                                    ...
                                    <td style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>
                                        {/* {count2.allowance?.filter((allowanceRow) => allowanceRow?.category === "OT Hours")?.map((allowanceRow) => {
                                            return (
                                                <tr style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                    <td>{allowanceRow?.value ?? 0}</td>
                                                </tr>
                                    ...
                                    <td style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>
                                        ...
                                        {Math.round((item?.companyDetails?.selectWages === 'Monthly Wages'
                                            ? Math.round(
                                                ((item?.salaryDetails?.basicSalary * parseInt(count.count, 10)) /
                                                    totalDaysOfMonth) / 26 / 4
                                            )
                                            : (
                                                (item.salaryDetails.basicSalary +
                                                    ...
                                                    item.salaryDetails.medical +
                                                    item.salaryDetails.education
                                                ) / 4)) * Math.round(count2?.allowance?.overTime))
                                        }
                                    </td>
                                    ...
                                    <td style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>
                                        {item?.companyDetails?.selectWages === 'Monthly Wages'
                                            ? Math.round(
                                                ...
                                                Math.round(((item?.salaryDetails?.basicSalary * parseInt(count.count, 10)) /
                                                    totalDaysOfMonth) / 26 / 4 * Math.round(count2?.allowance?.overTime))
                                            ) + Math.round(count.allowance?.filter((allowanceRow) => allowanceRow?.type == "allowence")?.reduce(
                                                (previousValue, currentValue) => previousValue + currentValue.value,
                                                0,
                                            ))
                                    ...
                                    <td style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>
                                        <tr>
                                            <td>
                                                {item?.pfDetails?.aboveBasic === 'PF but restricted to 15k' ? (
                                                    ...
                                                    <b>{Math.round((item?.salaryDetails?.basicSalary * count.count * 12) / 100)}</b>
                                                )}
                                            </td>
                                        </tr>
                                        {count.allowance?.filter((allowanceRow) => allowanceRow?.type == "recovery")?.map((allowanceRow) => (
                                        ...
                                        <tr>
                                            <td>
                                                {item?.pfDetails?.aboveBasic === 'PF but restricted to 15k' ? (
                                                    <b>{Math.round((1800)) + Math.round(count.allowance?.filter((allowanceRow) => allowanceRow?.type == "recovery")?.reduce(
                                                        (previousValue, currentValue) => previousValue + currentValue.value,
                                                        0,
                                                    )) + Math.round(
                                                        (item?.salaryDetails?.incomeTax)
                        ...
                        <tr>
                            ...
                            <td style={{ border: '1px solid black', borderCollapse: 'collapse', padding: '5px' }}>
                                ...
                                {pdfData?.employees?.reduce((total, num) => {
                                    ...
                                    let temp = num?.companyDetails?.selectWages === 'Monthly Wages'
                                        ? Math.round(
                                            ((num?.salaryDetails?.basicSalary * parseInt(count.count, 10)) / totalDaysOfMonth) / 26 / 4 *
                                            (count.ot ? count.ot : 0)
                                        )
                                        : Math.round(
                                            Math.round(
                                ...
                                {pdfData?.employees?.reduce((total, num) => {
                                    ...
                                    let temp = num?.companyDetails?.selectWages === 'Monthly Wages'
                                        ...
                                        : Math.round(
                                            ...
                                            num?.salaryDetails?.medical * parseInt(count.count, 10) +
                                            num?.salaryDetails?.education * parseInt(count.count, 10) +
                                            ((num?.salaryDetails?.basicSalary) + (num?.salaryDetails?.hra * parseInt(count.count, 10)) + (num?.salaryDetails?.con * parseInt(count.count, 10)) + (num?.salaryDetails?.medical * parseInt(count.count, 10)) + (num?.salaryDetails?.education * parseInt(count.count, 10)) / 4) * (count.ot ? count.ot : 0) -
                                            (num?.pfDetails?.aboveBasic === 'PF but restricted to 15k' ? (
                                                Math.round((1800))
                                            ) : num?.pfDetails?.aboveBasic === 'PF on actual' ||
                                                (num?.pfDetails?.wereMember == 'Yes' && num?.pfDetails?.withdrawn == 'No') ? (
