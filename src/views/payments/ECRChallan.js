                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">
                                                {item?.companyDetails?.selectWages === 'Monthly Wages'
                                                    ?
                                                    Math.round((item?.salaryDetails?.basicSalary * count.count) / totalDaysOfMonth) > 15000
                                                    ? 15000
                                                    : Math.round((item?.salaryDetails?.basicSalary * count.count) / totalDaysOfMonth)
                                                    :
                                                    Math.round(
                                            ...
                                            <TableCell align="center">
                                                ...
                                                :
                                                    Math.round(
                                                        (item?.salaryDetails?.basicSalary * parseInt(count.count, 10) * 8.33) / 100
                                                    )
                                                }
                                            </TableCell>
                                            <TableCell align="center">
                                            ...
                                            <TableCell
                                                align="center"> {totalDaysOfMonth - (count.count ? count.count : 0)} </TableCell>
                                        </StyledTableRow>
                                    );
                                })}
                            </TableBody>
            ...
            <div style={{display: 'none'}}>
                ...
                >
                    ...
                    <tr>
                        ...
                        <th style={{border: '1px solid black', borderCollapse: 'collapse', padding: '5px'}}>OT Wages
                        </th>
                        <th style={{
                            border: '1px solid black',
                            borderCollapse: 'collapse',
