...
const MachineAttendance = () => {
    ...
    React.useEffect(() => {
        dispatch(myAttendence(page, date.getMonth(), date.getFullYear(),keyword));
        if (error) {
            console.log(error);
            dispatch(clearErrors());
        }
    }, [dispatch, page, date,keyword]);
    ...
    return (
        <StyledMainCard>
            <AttendanceTopbar name="Machine Attendance" search="true" setKeyword={setKeyword} date="true" filter="true" parentCallback2={handleDate} />
                    ...
                    <StyledTable sx={{ minWidth: 650 }} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="center">OT Verification</StyledTableCell>
                                <StyledTableCell align="center">View Calender</StyledTableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
