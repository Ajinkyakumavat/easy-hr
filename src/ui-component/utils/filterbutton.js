        ...
        <Box sx={{ minWidth: 120 }}>
            <FormControl fullWidth>
                ...
                >
                    ...
                    <MenuItem value="Accident Leave">Accident Leave</MenuItem>
                    <MenuItem value="Maternity Leave">Maternity Leave</MenuItem>
                    <MenuItem value="Leave with Permission">Leave with Permission</MenuItem>
                    <MenuItem value="Leave without Permission">Leave without Permission</MenuItem>
        ...
        <Box sx={{ minWidth: 120 }}>
            <FormControl fullWidth>
                ...
                <Select
                    ...
                    onChange={(e) => { parentCallback3(e.target.value) }}
                >
                    <MenuItem value="All">All</MenuItem>
